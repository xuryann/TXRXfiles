...
//where 500uS is 2KHz or 25000 
#define WAVE_PERIOD 1100 /*4XKHz*/ // 6802 /*7.35KHz*/ // 25000 /*2KHz*/  // //120 //460 // 1200 //50000 // hundredths of usecs. (1e-8 msecs.)
#define WAVE_PIN 13
...
void setup() {
  ...
  SerialUSB.print("max period: "); 
  SerialUSB.print(action_tc1.max_period());
  SerialUSB.println(" hundreths of usecs.");
  SerialUSB.print("max period ticks: "); 
  SerialUSB.println(action_tc1.ticks(action_tc1.max_period()));
  SerialUSB.print("period: "); 
  SerialUSB.print(action_tc1.get_period());
  SerialUSB.println(" hundreths of usecs. (1e-8 secs.)");
  SerialUSB.print("ticks: "); 
  SerialUSB.println(action_tc1.ticks(WAVE_PERIOD));
...
void loop() {
  ...
  SerialUSB.println("********************************************************");  
  SerialUSB.print("--> [PIN "); SerialUSB.print(WAVE_PIN);
  SerialUSB.print(" -> PIN 2] duty: "); 
  SerialUSB.print(
    static_cast<double>(duty)/
    static_cast<double>(capture_pin2.ticks_per_usec()),
    3
  );
  SerialUSB.print(" usecs. period: ");
  SerialUSB.print(
